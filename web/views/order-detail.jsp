                                ...
                                <div>
                                    ...
                                    <div class="detail-card" style="margin-bottom: var(--spacing-lg)">
                                        ...
                                        <c:if test="${not empty order.description}">
                                            <div
                                                style="margin-top: var(--spacing-md); padding-top: var(--spacing-md); border-top: 1px solid var(--card-border)">
                                                <span class="detail-info-label">Mô tả sự cố</span>
                                                <p
                                                    style="margin-top:4px; color:var(--text-primary); font-size:var(--font-size-sm)">
                                                    ${order.description}</p>
                                            </div>
                                        </c:if>
                                        ...
                                        <table class="table-custom">
                                                ...
                                                <c:if test="${empty orderParts}">
                                                    <tr>
                                                        <td colspan="8" class="text-center"
                                                            style="padding:20px; color:var(--text-muted); font-style:italic">
                                            ...
                                            <tfoot>
                                                <tr style="font-weight:700; border-top: 2px solid var(--card-border)">
                                                    <td colspan="6" style="text-align:right">Tổng phụ tùng:</td>
                                                    <td colspan="2">
                                                ...
                                                <tr style="font-weight:700">
                                                    <td colspan="6" style="text-align:right">Phí Dịch Vụ:</td>
                                                    <td colspan="2">
                                                ...
                                                <tr
                                                    style="font-weight:800; font-size: var(--font-size-md); color:var(--primary)">
                                            ...
                                            <div class="detail-card">
                                                ...
                                                <c:choose>
                                                    <c:when
                                                        test="${order.status == 'Hoàn thành' || order.status == 'Đã giao'}">
                                                        <p
                                                            style="color:var(--text-muted); font-size:var(--font-size-sm); margin-bottom:var(--spacing-md)">
                                                        ...
                                                        <form action="Orders" method="POST">
                                                            ...
                                                            <div class="form-group"
                                                                style="margin-bottom:var(--spacing-md)">
                                                                <label class="form-label"
                                                                    style="font-size:var(--font-size-xs); font-weight:600">Phương
                                                            ...
                                                            <div
                                                                style="font-size:var(--font-size-sm); margin-bottom:var(--spacing-md)">
                                                                <div
                                                                ...
                                                                <div
                                                                    style="display:flex; justify-content:space-between; font-weight:800; font-size:var(--font-size-md); color:var(--primary); padding-top:8px; border-top:1px solid var(--card-border)">
                                                                    <span>Tổng:</span>
                                                    ...
                                                    <c:otherwise>
                                                        <p
                                                            style="color:var(--text-muted); font-size:var(--font-size-sm); font-style:italic">
