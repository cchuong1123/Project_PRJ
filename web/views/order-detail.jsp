                                                    ...
                                                    <c:if
                                                        ...
                                                        <form action="Orders" method="POST"
                                                            ...
                                                            <input type="date" name="warrantyEndDate"
                                                                   ...
                                                                   class="form-input-plain text-xs p-1 w-140px">
                                                            <button type="submit"
                                        ...
                                        <form action="Orders" method="POST">
                                            ...
                                            <div class="form-group mb-md">
                                                <label class="form-label text-xs font-semibold">Công
                                                    thợ (VNĐ)</label>
                                                <input type="number" class="form-input-plain text-sm p-sm"
                                            ...
                                            <div class="form-group mb-md">
                                                <label class="form-label text-xs font-semibold">Phương
                                            ...
                                            <div class="text-sm mb-md">
                                                ...
                                                <div class="flex flex-between font-extrabold text-md text-primary pt-sm border-top">
                                                    <span>Tổng:</span>
