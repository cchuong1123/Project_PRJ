                        ...
                        <main class="dashboard-main">
                            ...
                            <div class="report-summary">
                                ...
                                <div class="report-card">
                                    ...
                                    <div class="report-card-info">
                                        <span class="report-card-value">
                                            <fmt:formatNumber value="${totalProfit}" type="number" groupingUsed="true"
                                            ...
                                            <c:forEach var="inv" items="${invoices}">
                                                <tr>
                                                    ...
                                                    <td class="font-semibold text-muted">
                                                        <fmt:formatNumber value="${inv.cost}" type="number"
                                                            groupingUsed="true" />đ
                                                    </td>
                                                    <td class="font-bold text-success">
                                                        <fmt:formatNumber value="${inv.profit}" type="number"
                                                            groupingUsed="true" />đ
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                                ...
                                                <tr>
                                                    <td colspan="6" class="text-center p-xl">
                                                        <div class="empty-state">
                                                            ...
                                                            <p>Không tìm thấy hóa đơn trong khoảng thời gian đã chọn.
                                                            </p>
                                                        </div>
                                                    </td>
                                                </tr>
